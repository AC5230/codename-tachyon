module.exports = {
    ...
    host: "codename-tachyon.onrender.com", // Game server domain. If the host is 'localhost:NUMBER', the NUMBER must be the port setting.
    ...
    servers: [ // Make sure to change the HOST, PORT and SERVER_ID between servers!
        {
            ...
            region: "US/Ohio", // The region the server is on.
